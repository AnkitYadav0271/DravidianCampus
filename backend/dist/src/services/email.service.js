...
`,
        ...
        throw new Error("Having trouble in generating email please try again later");
    }
};
...
// });
export const generateContactEmail = async (args) => {
    try {
        const res = transporter.sendMail({
            sender: process.env.EMAIL,
            to: "dravidiancampus1@gmail.com",
            subject: `Contact query of  ${args.fullName}`,
            html: `
<div style="
    max-width:600px;
    margin:auto;
